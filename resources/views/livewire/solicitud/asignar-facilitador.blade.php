...
<div>
  ...
  <div class="max-w-7xl mx-auto space-y-10 mt-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
      ...
      <section class="rounded-2xl bg-white dark:bg-neutral-900 ring-1 ring-neutral-200 dark:ring-neutral-700 shadow-md p-8 flex flex-col items-center justify-center transition duration-300 ease-in-out hover:shadow-2xl">
        ...
        <div class="mt-5">
          <flux:modal.trigger name="asignar-facilitador-solicitante">
            <flux:button size="sm" variant="primary" icon="user-plus" aria-label="Asignar facilitador solicitante">
              {{ $solicitud->facilitadorSolicitante ? 'Cambiar facilitador solicitante' : 'Agregar facilitador solicitante' }}
            </flux:button>
          </flux:modal.trigger>
        </div>
      </section>
    ...
    <div class="mt-6">
      @if ($solicitud->coMediador)
        <div class="rounded-2xl bg-emerald-50 dark:bg-emerald-900/20 ring-1 ring-emerald-200 dark:ring-emerald-800 shadow-sm p-6">
