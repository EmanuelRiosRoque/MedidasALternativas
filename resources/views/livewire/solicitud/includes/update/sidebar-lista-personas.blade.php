 <aside
        ...
        <div class="flex flex-wrap gap-2">
            <template x-for="tipo in ['todos', 'solicitante', 'invitado']" :key="tipo">
                <button @click="filtro = tipo" class="px-3 py-1 rounded-full text-xs transition"
                    :class="filtro === tipo ? 'bg-emerald-500 text-white' : 'bg-white/20 text-white hover:bg-emerald-500'">
