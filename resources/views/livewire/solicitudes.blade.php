<div class="relative inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
    <div
        class="absolute w-[500px] h-[500px] bg-emerald-500/40 blur-[90px] dark:blur-[120px] rounded-full top-1/2 right-1/2 -translate-x-1/2 -translate-y-1/2 z-0 pointer-events-none animate__animated animate__backInRight">
    </div>
        ...
        <section class="w-full max-w-7xl z-20 animate__animated animate__fadeInUp">
            ...
            <div class="mt-6 sm:flex sm:items-center sm:justify-between">
                ...
                <div class="flex items-center mt-4 gap-x-4 sm:mt-0">
                    <a href="#" class="px-5 py-2 text-sm text-neutral-700 bg-white border rounded-md dark:bg-neutral-900 dark:text-neutral-200 dark:border-neutral-700 dark:hover:bg-neutral-800">Anterior</a>
                    <a href="#" class="px-5 py-2 text-sm text-neutral-700 bg-white border rounded-md dark:bg-neutral-900 dark:text-neutral-200 dark:border-neutral-700 dark:hover:bg-neutral-800">Siguiente</a>
                </div>
            </div>
        </section>
    </div>
