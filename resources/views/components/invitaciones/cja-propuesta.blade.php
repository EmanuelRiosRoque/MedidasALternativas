<div class="space-y-6">
    <div
        ...
        <div class="flex items-center gap-3">
            <span
                class="inline-flex items-center gap-2 rounded-xl bg-red-100 text-red-800 dark:bg-red-700/40 dark:text-red-100 ring-1 ring-red-200 dark:ring-red-600/40 px-3 py-1 text-sm font-semibold">
    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
        ...
        <div class="md:col-span-6 h-full rounded-xl p-5">
            ...
            <div class="space-y-3">
                <div class="sm:grid sm:grid-cols-5 sm:gap-3 sm:items-center">
                    ...
                    <div
                        class="sm:col-span-3 relative  focus-within:z-[999] w-full [&_input]:h-10 [&_input]:text-sm [&_input]:w-full">
                        <x-datetime-picker without-time placeholder="dd/mm/aaaa" display-format="DD/MM/YYYY"
                            ...
                            wire:model.defer="cja.propuesta_inicio_fecha" />
                    </div>
                </div>
                ...
                <div class="sm:grid sm:grid-cols-5 sm:gap-3 sm:items-center">
                    ...
                    <div class="sm:col-span-3 relative">
                        <x-datetime-picker without-time placeholder="dd/mm/aaaa" display-format="DD/MM/YYYY"
                            parse-format="YYYY-MM-DD" :clearable="true" :append-to-body="true" position="below"
                            class="w-full" wire:model.defer="cja.fecha_vencimiento" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="mb-3">
                <span
                    class="inline-flex items-center gap-2 rounded-full bg-yellow-100 text-yellow-800 dark:bg-yellow-400/20 dark:text-yellow-100 ring-1 ring-yellow-200 dark:ring-yellow-500/30 px-2.5 py-0.5 text-xs font-semibold">
            ...
            <div class="space-y-3">
                <div class="sm:grid sm:grid-cols-5 sm:gap-3 sm:items-center">
                    ...
                    <div class="sm:col-span-3 relative">
                        <x-datetime-picker without-time placeholder="dd/mm/aaaa" display-format="DD/MM/YYYY"
                            parse-format="YYYY-MM-DD" :clearable="true" :append-to-body="true" position="below"
                            class="w-full" wire:model.defer="cja.fecha_propuesta" />
                    </div>
                </div>
