...
<div class="p-6 relative isolate"  {{-- 👈 aislamos este include --}}
     x-data="{ deleteId: null }"
     x-on:delete:set.window="deleteId = $event.detail.id">
  ...
  <div class="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
    ...
    <div class="md:col-span-4">
      <div
        class="space-y-4 rounded-xl bg-white dark:bg-neutral-900 ring-1 ring-neutral-200 dark:ring-neutral-700 shadow-md p-4 md:sticky md:top-4 overflow-visible"> {{-- 👈 por si acaso --}}
        ...
        <div class="sm:grid sm:grid-cols-5 sm:gap-4 sm:items-center">
          ...
          {{-- 👇 este wrapper controla el stacking solo cuando hay foco --}}
          <div class="sm:col-span-3 relative">
            <x-datetime-picker
                ...
                position="below"
                class="w-full"
                wire:model.defer="obs.fecha_observacion"
            />
            </div>
    ...
    <div class="md:col-span-8">
      <div class="rounded-xl bg-white dark:bg-neutral-900 ring-1 ring-neutral-200 dark:ring-neutral-700 shadow-md text-xs overflow-visible"> {{-- 👈 por si acaso --}}
        <!-- Topbar -->
