<div x-data="{
    ...
    <div x-show="open" @click.away="open = false"
        ...
        @foreach([
        'bg-sky-100 dark:bg-sky-600' => 'Azul cielo',
        'bg-emerald-100 dark:bg-emerald-600' => 'Verde',
        'bg-rose-100 dark:bg-rose-600' => 'Rosa',
        'bg-purple-100 dark:bg-purple-600' => 'Morado',
        'bg-amber-100 dark:bg-amber-600' => 'Ámbar',
        'bg-orange-100 dark:bg-orange-600' => 'Naranja',
        'bg-cyan-100 dark:bg-cyan-600' => 'Cian',
        'bg-violet-100 dark:bg-violet-600' => 'Lila',
        'bg-lime-100 dark:bg-lime-600' => 'Lima',
        'bg-fuchsia-100 dark:bg-fuchsia-600' => 'Fucsia',
        ] as $value => $label)
