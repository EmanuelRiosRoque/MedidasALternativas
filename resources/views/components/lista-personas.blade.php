<div class="w-full flex justify-center py-5 md:py-10 px-4 bg-white dark:bg-neutral-900 ">
    <div
        class="p-4 w-full max-w-md bg-white rounded-lg shadow-md sm:p-8 dark:bg-neutral-800 dark:border-neutral-700 border hover:border-emerald-600 transform transition duration-300 ease-in-out hover:scale-[1.02]">
