...
<div class="p-4 w-full max-w-md bg-white rounded-lg shadow-md sm:p-8 dark:bg-neutral-800 dark:border-neutral-700 border hover:border-emerald-600 transform transition duration-300 ease-in-out hover:scale-[1.02]">
        <div class="flex justify-between items-center mb-4">
            <h3 class="text-xl font-bold leading-none text-neutral-900 dark:text-white">{{ $titulo }}</h3>
        </div>
        <div class="flow-root">
                    ...
                    <li class="py-3 sm:py-4">
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="inline-flex items-center text-base font-semibold text-neutral-900 dark:text-white">
                                <flux:button wire:click="cargarPersona({{ $persona->id }})" variant="primary" icon="pencil-square" />
                            </div>
                        </div>
                    </li>
                @endforeach
