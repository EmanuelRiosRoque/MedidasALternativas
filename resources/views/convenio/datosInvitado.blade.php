<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
    <div class="flex flex-wrap gap-x-6">
        ...
        <div class="animate__animated animate__fadeIn">
            <flux:radio.group wire:model.live="persona_invitado" label="Persona" >
...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2 animate__animated animate__fadeIn"> 
    @if (!empty($persona_invitado) && $persona_invitado === 'fisica')
        @include('convenio.formularioPersonaFisica',['prefix' => 'invitado'])
    @elseif (!empty($persona_invitado) && $persona_invitado === 'moral')
        @include('convenio.formularioPersonaMoral', ['prefix' => 'invitado'])
    @endif
</div>
