<div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-2 animate__animated animate__fadeIn"> 
    ...
    <flux:input
        wire:model="clave_faciliatador"
        :label="__('Clave o número de registro')"
        type="text"
        required
        placeholder="Clave o número de registro de certificación sistema nacional"
    />

    <flux:input
        wire:model="folio_facilitador"
    ...
    <flux:input
        wire:model="clave_unica_facilitador"
    ...
    <flux:input
        wire:model="domicilio_facilitador"
        :label="__('Domicilio')"
        type="text"
        required
        placeholder="Domicilio facilitador"
    />

    <flux:input
        wire:model="telefono_facilitador"
        :label="__('Telefono')"
        type="text"
        required
        placeholder="Telefono facilitador"
    />

    <flux:input
        wire:model="correo_facilitador"
        :label="__('Correo electronico')"
        type="email"
        required
        placeholder="Correo electronico facilitador"
    />
 
    <flux:input
        wire:model="fecha_certificion_facilitador"
        :label="__('Fecha de certificion')"
        type="date"
        required
        placeholder="Fecha de certificion facilitador"
    />

    <flux:input
        wire:model="vigencia_certificion_facilitador"
        :label="__('Vigencia de certificion')"
        type="date"
        required
        placeholder="Vigencia de certificion facilitador"
    />
    <div class="mt-5 mb-2 animate__animated animate__fadeIn tetx col-span-3">
