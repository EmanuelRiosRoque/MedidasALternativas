<div class="relative grid min-h-[95vh] place-items-center px-4 bg-gradient-to-br from-white to-neutral-100 dark:from-neutral-800 dark:to-neutral-900 overflow-hidden">
    ...
    {{-- 🔵 Círculo con blur tipo glow emerald justo detrás del contenedor --}}
        ...
        <div class="text-center space-y-6">
            ...
            <div class="mt-6">
                <a
                    ...
                    class="inline-block px-8 py-3 bg-emerald-800 text-white font-semibold rounded-full shadow-lg hover:bg-emerald-900 hover:scale-105 transition transform duration-300"
                >
                    Acceder al Panel
                </a>
            </div>
